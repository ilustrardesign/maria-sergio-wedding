...
export function renderRsvpGuestEmail({ selectedGuests }: RsvpGuestEmailData) {
  ...
  const siteLink = (siteUrl || "https://mariaesergio.com").replace(/\/$/, "");
  const monogramUrl = `${siteLink}/images/brand/monogram-email.png`;
