      ...
      {selectedGift ? (
        <div aria-labelledby="gift-modal-title" aria-modal="true" className={styles.giftModal} role="dialog">
          ...
          <div className={styles.giftModalPanel}>
            ...
            <p className={styles.giftModalPrice}>{selectedGift.price}</p>
            {selectedGift.customAmount ? (
            ...
            <button
              ...
              disabled={charge.status === "loading" || (selectedGift.customAmount && !selectedAmount)}
            ...
            {charge.status === "ready" ? (
              <div className={styles.pixState}>
                ...
                <p>Escaneie o QR Code com o aplicativo do seu banco ou use o Pix Copia e Cola.</p>
                <Image alt="" height={220} src={charge.qrCode} unoptimized width={220} />
                <textarea aria-label="Pix Copia e Cola" readOnly value={charge.pixCopyPaste} />
                <button className={styles.pixCopyButton} onClick={() => copyPixCode(charge.pixCopyPaste)} type="button">
                  {copyMessage === "Código Pix copiado" ? "Código Pix copiado" : "Copiar código Pix"}
                </button>
            ...
            {charge.status === "error" ? <p className={styles.pixError}>{charge.message}</p> : null}
